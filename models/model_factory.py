...
def _build_image_model(image_arch, embedding_dim):
    ...
    image_model = timm.create_model(image_arch, pretrained=True)
...
def _build_text_model(text_arch, max_length, embedding_dim):
...
def build_image_text_model(
    ...
    # Build Image Model
    image_model = _build_image_model(image_arch, embedding_dim)
    ...
    # Build Text Model
    text_model = _build_text_model(text_arch, max_token_length, embedding_dim)
